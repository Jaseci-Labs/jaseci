...
ranking. For example, if you have a node called \lstinline{movie review} with a
...
input list of nodes. This action does not support arhcitypes lacking an anchor.\vspace{4mm}\par
\argspec{Parameters}{
...
\argspec{Returns}{A node or edge object}}
\apispec{net.pack}{item_set: jac_set (*req), destroy: bool (False)}

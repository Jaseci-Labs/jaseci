\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$actions$}
...
\argspec{
\texttt{url} -- The url of the API server supporting Jaseci actions.\par
}}
...
actions. If left blank all actions from all loaded sets will be shown.\par
}}
...
objects.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$architype$}
...
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$config$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$global$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$graph$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$master$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$object$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$sentinel$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$stripe$}
...
{No documentation yet.}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$super$}
...
{other fields used for additional feilds for overloaded interfaces
(i.e., Dango interface)}
\subsection{APIs for \lstinline[basicstyle=\Large\ttfamily]$walker$}

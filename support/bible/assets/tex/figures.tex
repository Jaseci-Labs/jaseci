...
\newcommand{\printtabDateStd}{
    \begin{table}[ht]\footnotesize\centering\begin{tabular}{l l l}\toprule\textbf{Action}&\textbf{Args}&\textbf{Description}\\\midrule
...
\newcommand{\printtabJSAPI}{
    ...
    \begin{longtable}{l | p{10cm}}
        ...
        \midrule
        \input{assets/tex/js_generated/api_cheatsheet.tex}
        \bottomrule
        \hiderowcolors

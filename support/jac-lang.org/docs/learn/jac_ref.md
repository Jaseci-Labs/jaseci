...
## Abilities
```yaml linenums="67"
--8<-- "jaclang/compiler/jac.lark:67:78"
```
=== "jac"
    ```jac linenums="1"
...
## Global variables
```yaml linenums="81"
--8<-- "jaclang/compiler/jac.lark:81:82"
```
=== "jac"
    ```jac linenums="1"
...
## Implementations
```yaml linenums="94"
--8<-- "jaclang/compiler/jac.lark:94:97"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="100"
--8<-- "jaclang/compiler/jac.lark:100:127"
```
=== "jac"
    ```jac linenums="1"
...
## If statements
```yaml linenums="130"
--8<-- "jaclang/compiler/jac.lark:130:132"
```
=== "jac"
    ```jac linenums="1"
...
## While statements
```yaml linenums="135"
--8<-- "jaclang/compiler/jac.lark:135:135"
```
=== "jac"
    ```jac linenums="1"
...
## For statements
```yaml linenums="138"
--8<-- "jaclang/compiler/jac.lark:138:139"
```
=== "jac"
    ```jac linenums="1"
...
## Try statements
```yaml linenums="142"
--8<-- "jaclang/compiler/jac.lark:142:145"
```
=== "jac"
    ```jac linenums="1"
...
## Match statements
```yaml linenums="148"
--8<-- "jaclang/compiler/jac.lark:148:149"
```
=== "jac"
    ```jac linenums="1"
...
## Match patterns
```yaml linenums="152"
--8<-- "jaclang/compiler/jac.lark:152:162"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="174"
--8<-- "jaclang/compiler/jac.lark:174:175"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="178"
--8<-- "jaclang/compiler/jac.lark:178:180"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="183"
--8<-- "jaclang/compiler/jac.lark:183:187"
```
=== "jac"
    ```jac linenums="1"
...
## Context managers
```yaml linenums="190"
--8<-- "jaclang/compiler/jac.lark:190:192"
```
=== "jac"
    ```jac linenums="1"
...
## Assignments
```yaml linenums="242"
--8<-- "jaclang/compiler/jac.lark:242:259"
```
=== "jac"
    ```jac linenums="1"
...
## Pipe expressions
```yaml linenums="268"
--8<-- "jaclang/compiler/jac.lark:268:268"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="271"
--8<-- "jaclang/compiler/jac.lark:271:271"
```
=== "jac"
    ```jac linenums="1"
...
## Elvis expressions
```yaml linenums="274"
--8<-- "jaclang/compiler/jac.lark:274:274"
```
=== "jac"
    ```jac linenums="1"
...
## Bitwise expressions
```yaml linenums="277"
--8<-- "jaclang/compiler/jac.lark:277:280"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="283"
--8<-- "jaclang/compiler/jac.lark:283:295"
```
=== "jac"
    ```jac linenums="1"
...
```yaml linenums="416"
--8<-- "jaclang/compiler/jac.lark:416:624"
```
=== "jac"
    ```jac linenums="1"

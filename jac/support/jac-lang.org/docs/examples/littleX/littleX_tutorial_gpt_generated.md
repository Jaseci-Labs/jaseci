...
**Key Points:**
- A descriptive string (in quotes) explains the function’s purpose.
...
For further examples of LLM integration, refer to the [Usage of MTLLM documentation](https://www.jac-lang.org/for_coders/jac-mtllm/usage/) cite22†.
...
Edges define how nodes connect. Three edge types are declared:
...
Walkers are processes that traverse the graph, executing abilities on nodes as they go.
...
### 6.2 The `visit` Keyword for Graph Traversal

...
To visualize the Jac graph while debugging, open the graph visualize view using the command `jacvis: Visualize Jaclang Graph` in the command palette, (shortcut for command palette is `ctrl+shift+p`)

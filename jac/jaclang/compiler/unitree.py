...
class PyInlineCode(
    ElementStmt, ArchBlockStmt, EnumBlockStmt, CodeBlockStmt, UniBasicBlock
):
...
class RaiseStmt(CodeBlockStmt, UniBasicBlock):
...
class IgnoreStmt(WalkerStmtOnlyNode, CodeBlockStmt, UniBasicBlock):

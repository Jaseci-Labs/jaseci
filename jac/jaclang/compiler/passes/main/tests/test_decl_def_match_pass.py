...
class DeclImplMatchPassTests(TestCase):
    ...
    def test_ability_connected_to_decl(self) -> None:
        ...
        self.assertIn("(o)Test.(c)say_hi", state.root_ir.sym_tab.tab)
        self.assertIsNotNone(
            state.root_ir.sym_tab.tab["(o)Test.(c)say_hi"].decl.name_of.body
        )
        self.assertIn("(o)Test.(c)__init__", state.root_ir.sym_tab.tab)
        self.assertIsNotNone(
            state.root_ir.sym_tab.tab["(o)Test.(c)__init__"].decl.name_of.body
        )

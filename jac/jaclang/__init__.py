...
# (thakee): jobj is not part of the builtins but jid is, Not sure why one is a feature and the other
# is not. However I've added jobj in this list to make it looks the same type of functions.
jac_builtin_funcs = [
    "dotgen",
    "jid",
    "jobj",

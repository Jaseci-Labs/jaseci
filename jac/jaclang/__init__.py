...
class JacNode(_JacArchiTypeBase, metaclass=JacMetaNode):
    ...
    def connect(
        self, node: "JacNode", edge: "JacEdge | None" = None, unidir: bool = False
    ) -> "JacNode":
...
root.spawn = types.MethodType(JacNode.spawn, root)  # type: ignore [attr-defined]
root.connect = types.MethodType(JacNode.connect, root)  # type: ignore [attr-defined]

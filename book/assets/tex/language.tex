...
Jac Code~\ref{jac:jac_preview.jac} presents a sequence of operations that creates nodes and edges and produces a relatively simple complex graph. There is a bunch of new syntactic goodness presented in these 10 lines of code and I certainly won't describe them all here. The goal is to simply whet your appitite on whats to come. But lets look at the state of our data (memory) shown in Figure~\ref{dot:jac_preview}.


Yep, there a good bit going on here. in just 10 lines of code we've done the following things:
\begin{enumerate}[itemsep=0mm]
    ...
    \item Travel to \texttt{n1} (and do nothing)
    \item Travel to \texttt{n2} (and do nothing)
\end{enumerate}

Ok, I'll wait until you pick your jaw up off the floor. \dots I told you. Yessiree, this is going to get very interesting indeed\dots
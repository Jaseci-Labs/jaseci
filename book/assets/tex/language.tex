...
\begin{nerd}
    Grammar~\ref{gram:jac.g4:124:130} shows  the lines from the formal grammar for Jac that corresponds to the parsing of arithmetic.
    \gramcoderange{jac.g4}{Jac grammar clip relevant to arithmetic}{124}{130}
\end{nerd}
...
\begin{nerd}
    Grammar~\ref{gram:jac.g4:114:122} shows the lines from the formal grammar for Jac that corresponds to the parsing of comparison, logical, and membership operations.
    \gramcoderange{jac.g4}{Jac grammar clip relevant to comparison, logic, and membership}{114}{122}
\end{nerd}
...
\begin{nerd}
    Grammar~\ref{gram:jac.g4:114:122} shows the lines from the formal grammar for Jac that corresponds to the parsing of assignment operations.
    \gramcoderange{jac.g4}{Jac grammar clip relevant to assignment}{102}{110}
\end{nerd}

...
* **Steps for running `fasttext.jac` programm**
    ...
    4. You'll find the following logs on console
        ...
        **training logs**
        ...
        Training...
        Wrote 261 sentences to C:\Users\satyam.singh\anaconda3\envs\pytorch\lib\site-packages\jaseci_kit\modules\fasttext\pretrained_model\train.txt
        Read 0M words
        Number of words:  577
        Number of labels: 10
        ...
        Model saved to C:\Users\satyam.singh\anaconda3\envs\pytorch\lib\site-packages\jaseci_kit\modules\fasttext\pretrained_model\model.ftz.

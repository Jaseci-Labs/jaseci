...
# TODO Parameterize the model_name for synthesizer, female, male voices.
# Parameterize the speaker id
...
def synthesize(input_text: str, speaker: str, save_path: str = ""):
    ...
    speaker_id = {
        "male": speech_model.speakers[3], "female": speech_model.speakers[2]}
    ret_dict = {}
    ...
    try:
        if save_path != "":
            ...
            audio_wav = speech_model.tts(
                input_text, speaker=speaker_id[speaker])

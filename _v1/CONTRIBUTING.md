...
- [Contributing to the Jaseci Open Source Project](#contributing-to-the-jaseci-open-source-project)
  - [How to be a Jaseci Contributor](#how-to-be-a-jaseci-contributor)
  ...
  - [How to contribute code](#how-to-contribute-code)
    ...
    - [Things to know about creating a PR](#things-to-know-about-creating-a-pr)
      ...
      - [Draft/Work-in-progress(WIP) PRs](#draftwork-in-progresswip-prs)
      - [Validate your changes through test](#validate-your-changes-through-test)
      - [Code style \& Linting](#code-style--linting)
  - [CI/CD](#cicd)
    - [Regression Tests on PR](#regression-tests-on-pr)
    - [Build and Release](#build-and-release)
  - [How to Update the Official Documentation](#how-to-update-the-official-documentation)
    - [Adding a new module or library](#adding-a-new-module-or-library)
    - [Adding a new code lab example](#adding-a-new-code-lab-example)
    - [Adding a new guide](#adding-a-new-guide)

---

## How to be a Jaseci Contributor
...
**General Guidelines to Casual Contributors**
...
2. The Committed Jaseci-tributor
...
**General Guidelines to Commited Jaseci-tributors**

- Come to the meetings or share in relevant Slack channel a note before, or we will worry insensently that something is terribly wrong
- For a given thing (e.g., task, todo, doc, note, comment, delegation, request for help, etc), it exists if it is present in our system of Objective and Centralized Truth (OCT for short, aka Click-Up atm, links to other systems like github, and google docs are ok).
- For the days committed to work, if nothing is checked off, leave a little comment on how things went if nothing gets checked off that day.

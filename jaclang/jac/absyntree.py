...
class GlobalVars(OOPAccessNode):
    ...
    def __init__(
        ...
        super().__init__(access=access, parent=parent, mod_link=mod_link, kid=[])
...
class PyInlineCode(AstNode):
    ...
    def __init__(
        ...
        self.code = code
        super().__init__(parent=parent, mod_link=mod_link, kid=kid, tok_range=tok_range)

...
def gen_standalone(lark_inst, output=None, out=sys.stdout, compress=False):
    ...
    output(
        "# The file was automatically generated by Lark v%s"
        % jaclang.vendor.lark.__version__
    )
    output('__version__ = "%s"' % jaclang.vendor.lark.__version__)
    output()
...
def main():
    ...
    parser = ArgumentParser(
        prog="prog='python -m jaclang.vendor.lark.tools.standalone'",

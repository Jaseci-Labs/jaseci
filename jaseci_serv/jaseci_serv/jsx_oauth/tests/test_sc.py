...
class SocialAccountTests(TestCase):
    ...
    def test_email_address_created(self):
        ...
        # import pdb
        # pdb.set_trace()
        # account_settings.USER_MODEL_USERNAME_FIELD = "email"

        User = get_user_model()
        user = User()
        # setattr(user, account_settings.USER_MODEL_USERNAME_FIELD, "test@example.com")
        ...
        user = User.objects.get(
            **{account_settings.USER_MODEL_EMAIL_FIELD: "test@example.com"}
        )
        import pdb

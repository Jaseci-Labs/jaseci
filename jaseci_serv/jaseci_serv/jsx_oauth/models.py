...
# class LicenseCheckStatus(SingletonModel):
#     last_checked = models.DateTimeField(blank=True, null=True)
#     license_validity = models.DateTimeField(blank=True, null=True)
#     license_status = models.BooleanField(blank=True, null=True, default=False)
#     is_user_active = models.BooleanField(blank=True, null=True, default=False)

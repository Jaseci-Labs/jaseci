...
class test_ll_productivity_insights(TestCaseHelper, TestCase):
    ...
    def setUp(self):
        ...
        ll_loc = os.path.dirname(__file__) + '/ll_productivity_insights.jac'
    ...
    def test_ll_highlevel_groups(self):
        ...
        self.run_walker('get_gen_day', {"date": "2021-07-12"})
        ...
        self.graph_node_set(g1_item2[0]['jid'], {"status": "done"})
        ...
        self.graph_node_set(g1_item3[0]['jid'], {"status": "done"})

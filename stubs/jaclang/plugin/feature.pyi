...
from jaclang.plugin.default import Architype as Architype, EdgeArchitype as EdgeArchitype, JacFeatureDefaults as JacFeatureDefaults, NodeArchitype as NodeArchitype, Root as Root, T as T, WalkerArchitype as WalkerArchitype
...
class JacFeature:
    ...
    @staticmethod
    def jac_import(target: str, base_path: str, cachable: bool = True, override_name: Optional[str] = None) -> Optional[types.ModuleType]: ...
    @staticmethod

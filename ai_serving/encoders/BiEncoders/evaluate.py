...
from tokenizer import SelectionJoinTransform, SelectionSequentialTransform,SelectionData,ContextData,CandidateData,SelectionDataset
import configparser
...
def get_inference(model,tokenizer,context,candidate):
    ...
    test_data = SelectionDataset(context,candidate,context_transform, candidate_transform)

...
def trainIntent(text:str,topic:str,label:str):
    ...
    tars.add_and_switch_to_new_task("Train Data", label_dictionary=corpus.make_label_dictionary(label_type=topic),label_type=topic)
    ...
    trainer.train(base_path=directory, # path to store the model artifacts
                learning_rate=0.02, 
                mini_batch_size=1, 
                max_epochs=10,
                train_with_dev=True

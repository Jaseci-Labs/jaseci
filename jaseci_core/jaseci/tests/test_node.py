...
class NodeTests(TestCaseHelper, TestCase):
    ...
    def test_node_connections(self):
        ...
        node1 = Node(m_id="anon", h=self.meta.hook(), sent=None)
        node2 = Node(m_id="anon", h=node1._h, sent=None)
        node3 = Node(m_id="anon", h=node1._h, sent=None)
        node4 = Node(m_id="anon", h=node1._h, sent=None)
    ...
    def test_add_entry_action_to_node_and_destroy(self):
        """Test connecting and disconnecting etc of nodes"""
        node1 = Architype(m_id="anon", h=self.meta.hook())
    ...
    def test_adding_and_removing_from_hdnodes(self):
        ...
        node1 = Node(m_id="anon", h=self.meta.hook(), sent=None)
        hdgd1 = Node(m_id="anon", h=node1._h, name="yeah dude", dimension=1, sent=None)
        ...
        hdgd2 = Node(m_id="anon", h=node1._h, dimension=2, sent=None)
    ...
    def test_inherit_from_element_edge(self):
        ...
        a = Edge(
            ...
            m_id="anon",
            h=hook,
            to_node=Node(m_id="anon", h=hook, sent=None),
            from_node=Node(m_id="anon", h=hook, sent=None),
            sent=None,
        )

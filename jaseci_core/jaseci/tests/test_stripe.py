...
class StripeTests(CoreTest):
    ...
    @jac_testcase("stripe.jac", "search_customer")
    def test_stripe_search_customer(self, ret):
        stripe.Customer.search.assert_called_once_with(query="email:'test12@gmail.com'")

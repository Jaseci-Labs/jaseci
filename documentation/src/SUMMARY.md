...
# Getting Started 
- [ Jaseci Overview](support/guide/getting_started/introduction.md)
- [ Installing Jaseci](support/guide/getting_started/installation.md)
- [ Setting up your Code Editor](support/guide/getting_started/setting_up_your_editor.md)
...
- [An Overview of the JAC Language](support/guide/jac_language_guide/jac_language_overview.md)
- [ JAC Grammar](support/guide/jac_language_guide/jac_grammar.md)
- [ keywords](support/guide/jac_language_guide/keywords.md)
...
- [ Actions in Jaseci](support/guide/jac_language_guide/actions.md)
...
- [CanoniCAI](examples/canoniCAI/readme.md)
     ...
     - [Adding a following up state](examples/canoniCAI/documentation/add_followup_state.md)
     - [Building FAQ States](examples/canoniCAI/documentation/add_followup_state.md)
     - [Fixing Utterance](examples/canoniCAI/documentation/fixing_utterances.md)
...
- [Entity Recongition](jaseci_kit/modules/entity_utils/README.md)

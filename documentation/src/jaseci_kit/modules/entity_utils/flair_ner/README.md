...
* **Zero-Shot entity detection**
    ...
    **Results**
    ...
    From this results we will get following insight, if we have number of labels is less, we will get higher accuracy and f1_score.### Entity Extraction Using `FLAIR NER(ent_ext)`

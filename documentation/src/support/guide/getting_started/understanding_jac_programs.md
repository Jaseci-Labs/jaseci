...
The Walker can move from node to node along edges. It can also be spawned directly on any node without the need for a traversal# Getting Started
# Understanding JAC Programs
...
The Walker can move from node to node along edges. It can also be spawned directly on any node without the need for a traversal# Understanding JAC Programs

...
* Once the guide is added, ensure that you update the main `README.md` in the root directory of the codebase to include references to your new guide under the applicable section.# Contributing to the Jaseci Open Source Project

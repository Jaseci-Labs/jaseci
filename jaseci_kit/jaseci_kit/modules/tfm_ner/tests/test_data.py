...
test_training_data = [
    ...
    "my name is [jason](name) and i [mars](address) in mars",
    "i live in [space](address) and th[jack](name)all me jack",
    "I'm [eldon](name) and i re[lot 2 queen street](address)n street",
    "I currently live in [Georgetown](address[Ashish](name) I'm Ashish",

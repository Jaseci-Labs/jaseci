...
2.  Load `text_seg` module in jac by command
    ```
    actions load module jaseci_kit.text_seq
    ```


## **2. Get segments**
For this tutorial, we are going to leverage the **text segmenter** (`text_seg`) for text segmentation, 
        ...
        * Execute the walker `text_segment` with default parameter for `text segmentation (text_seg)` module by following command
            ...
            **Result**
            ...
            "report": [
                ...
                "Battle after battle had been fought.",
                ...
                "He was tired and unhappy. He was ready to give up all hope.",
                "It seemed to him that there was no use for him to try to do anything more.",
